...
async function run() {
    try {
        console.log('Fetching properties for Billetterie account...');
        ...
        fs.writeFileSync('hubspot_billetterie_props.json', JSON.stringify(properties, null, 2));
        console.log('Saved to hubspot_billetterie_props.json');

        // Also check if any contacts exist
        ...
        console.log('Total contacts in Billetterie:', searchResponse.data.total);
