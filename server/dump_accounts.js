...
async function debugPL() {
    try {
        ...
        const now = new Date();
        const from = '2025-01-01'; // Year start
        ...
        fs.writeFileSync('all_accounts.json', JSON.stringify(flattened, null, 2));
        console.log(`Dumped ${flattened.length} accounts to all_accounts.json`);
